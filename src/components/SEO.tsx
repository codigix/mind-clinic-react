...
export const seoConfigs = {
  home: {
    ...
    description:
      "Expert psychiatric care by Dr. Hamza Hussain at Insight - The Mind Clinic. Specialized in depression, anxiety, OCD, and mental health treatment in Pune.",
  ...
  services: {
    ...
    description:
      "Comprehensive mental health services including depression treatment, anxiety therapy, OCD management, and psychiatric consultation in Pune.",
    keywords: ["depression treatment pune", "anxiety therapy", "ocd treatment"],
  },
  about: {
    title: "About Dr. Hamza Hussain | Gold Medalist Psychiatrist",
    description:
      "Meet Dr. Hamza Hussain, gold medalist psychiatrist with 15+ years experience. Learn about our holistic approach to mental health care.",
